...
type QueryResolver interface {
	...
	Hover(ctx context.Context, line, character int) (string, clienttypes.Range, bool, error)
...
func (r *queryResolver) Definitions(ctx context.Context, line, character int) ([]AdjustedLocation, error) {
	position := clienttypes.Position{Line: line, Character: character}
...
func (r *queryResolver) Hover(ctx context.Context, line, character int) (string, clienttypes.Range, bool, error) {
	position := clienttypes.Position{Line: line, Character: character}
...
func (r *queryResolver) Diagnostics(ctx context.Context, limit int) ([]AdjustedDiagnostic, int, error) {
	...
	for i := range allDiagnostics {
		clientRange := clienttypes.Range{
			Start: clienttypes.Position{Line: allDiagnostics[i].Diagnostic.StartLine, Character: allDiagnostics[i].Diagnostic.StartCharacter},
			End:   clienttypes.Position{Line: allDiagnostics[i].Diagnostic.EndLine, Character: allDiagnostics[i].Diagnostic.EndCharacter},
		}
...
func (r *queryResolver) adjustRange(ctx context.Context, repositoryID int, commit, path string, rx clienttypes.Range) (string, clienttypes.Range, error) {
