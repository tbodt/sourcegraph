...
func TestRanges(t *testing.T) {
	...
	mockCodeIntelAPI.RangesFunc.PushReturn([]codeintelapi.ResolvedCodeIntelligenceRange{
		{
			Range:       clienttypes.Range{Start: clienttypes.Position{Line: 11, Character: 12}, End: clienttypes.Position{Line: 13, Character: 14}},
			Definitions: []codeintelapi.ResolvedLocation{{Dump: store.Dump{ID: 44, RepositoryID: 50}, Path: "p1.go", Range: clienttypes.Range{Start: clienttypes.Position{Line: 111, Character: 121}, End: clienttypes.Position{Line: 131, Character: 141}}}},
			References:  []codeintelapi.ResolvedLocation{{Dump: store.Dump{ID: 44, RepositoryID: 50}, Path: "p1.go", Range: clienttypes.Range{Start: clienttypes.Position{Line: 112, Character: 122}, End: clienttypes.Position{Line: 132, Character: 142}}}},
			HoverText:   "ht1",
		},
		{
			Range:       clienttypes.Range{Start: clienttypes.Position{Line: 21, Character: 22}, End: clienttypes.Position{Line: 23, Character: 24}},
			Definitions: []codeintelapi.ResolvedLocation{{Dump: store.Dump{ID: 44, RepositoryID: 50}, Path: "p2.go", Range: clienttypes.Range{Start: clienttypes.Position{Line: 211, Character: 221}, End: clienttypes.Position{Line: 231, Character: 241}}}},
			References:  []codeintelapi.ResolvedLocation{{Dump: store.Dump{ID: 44, RepositoryID: 50}, Path: "p2.go", Range: clienttypes.Range{Start: clienttypes.Position{Line: 212, Character: 222}, End: clienttypes.Position{Line: 232, Character: 242}}}},
			HoverText:   "ht2",
		},
		{
			Range:       clienttypes.Range{Start: clienttypes.Position{Line: 31, Character: 32}, End: clienttypes.Position{Line: 33, Character: 34}},
			Definitions: []codeintelapi.ResolvedLocation{{Dump: store.Dump{ID: 44, RepositoryID: 50}, Path: "p3.go", Range: clienttypes.Range{Start: clienttypes.Position{Line: 311, Character: 321}, End: clienttypes.Position{Line: 331, Character: 341}}}},
			References:  []codeintelapi.ResolvedLocation{{Dump: store.Dump{ID: 44, RepositoryID: 50}, Path: "p3.go", Range: clienttypes.Range{Start: clienttypes.Position{Line: 312, Character: 322}, End: clienttypes.Position{Line: 332, Character: 342}}}},
			HoverText:   "ht3",
		},
	}, nil)
	...
	mockPositionAdjuster.AdjustRangeFunc.SetDefaultHook(func(ctx context.Context, path, commit string, r clienttypes.Range, reverse bool) (string, clienttypes.Range, bool, error) {
		return path, clienttypes.Range{
			Start: clienttypes.Position{Line: r.Start.Line * 10, Character: r.Start.Character * 10},
			End:   clienttypes.Position{Line: r.End.Line * 10, Character: r.End.Character * 10},
		}, true, nil
	})
	...
	expectedRanges := []AdjustedCodeIntelligenceRange{
		{
			Range: clienttypes.Range{Start: clienttypes.Position{Line: 110, Character: 120}, End: clienttypes.Position{Line: 130, Character: 140}},
			Definitions: []AdjustedLocation{
				{
					Dump:           store.Dump{ID: 44, RepositoryID: 50},
					Path:           "p1.go",
					AdjustedCommit: "deadbeef2",
					AdjustedRange:  clienttypes.Range{Start: clienttypes.Position{Line: 1110, Character: 1210}, End: clienttypes.Position{Line: 1310, Character: 1410}},
				},
			},
			References: []AdjustedLocation{
				{
					...
					Path:           "p1.go",
					AdjustedCommit: "deadbeef2",
					AdjustedRange:  clienttypes.Range{Start: clienttypes.Position{Line: 1120, Character: 1220}, End: clienttypes.Position{Line: 1320, Character: 1420}},
				},
			},
			HoverText: "ht1",
		},
		{
			Range: clienttypes.Range{Start: clienttypes.Position{Line: 210, Character: 220}, End: clienttypes.Position{Line: 230, Character: 240}},
			Definitions: []AdjustedLocation{
				{
					Dump:           store.Dump{ID: 44, RepositoryID: 50},
					Path:           "p2.go",
					AdjustedCommit: "deadbeef2",
					AdjustedRange:  clienttypes.Range{Start: clienttypes.Position{Line: 2110, Character: 2210}, End: clienttypes.Position{Line: 2310, Character: 2410}},
				},
			},
			References: []AdjustedLocation{
				{
					...
					Path:           "p2.go",
					AdjustedCommit: "deadbeef2",
					AdjustedRange:  clienttypes.Range{Start: clienttypes.Position{Line: 2120, Character: 2220}, End: clienttypes.Position{Line: 2320, Character: 2420}},
				},
			},
			HoverText: "ht2",
		},
		{
			Range: clienttypes.Range{Start: clienttypes.Position{Line: 310, Character: 320}, End: clienttypes.Position{Line: 330, Character: 340}},
			Definitions: []AdjustedLocation{
				{
					Dump:           store.Dump{ID: 44, RepositoryID: 50},
					Path:           "p3.go",
					AdjustedCommit: "deadbeef2",
					AdjustedRange:  clienttypes.Range{Start: clienttypes.Position{Line: 3110, Character: 3210}, End: clienttypes.Position{Line: 3310, Character: 3410}},
				},
			},
			References: []AdjustedLocation{
				{
					...
					Path:           "p3.go",
					AdjustedCommit: "deadbeef2",
					AdjustedRange:  clienttypes.Range{Start: clienttypes.Position{Line: 3120, Character: 3220}, End: clienttypes.Position{Line: 3320, Character: 3420}},
				},
			},
			HoverText: "ht3",
		},
...
func TestDefinitions(t *testing.T) {
	...
	mockPositionAdjuster.AdjustPositionFunc.SetDefaultReturn("", clienttypes.Position{Line: 20, Character: 15}, true, nil)

	// first requested dump (dump 42) has no equivalent position
	mockPositionAdjuster.AdjustPositionFunc.PushReturn("", clienttypes.Position{}, false, nil)
	...
	mockCodeIntelAPI.DefinitionsFunc.SetDefaultReturn([]codeintelapi.ResolvedLocation{
		{
			...
			Range: clienttypes.Range{
				Start: clienttypes.Position{Line: 11, Character: 12},
				End:   clienttypes.Position{Line: 13, Character: 14},
			},
		},
		{
			Dump: store.Dump{ID: 44, RepositoryID: 50},
			Path: "p2.go",
			Range: clienttypes.Range{
				Start: clienttypes.Position{Line: 21, Character: 22},
				End:   clienttypes.Position{Line: 23, Character: 24},
			},
		},
		{
			Dump: store.Dump{ID: 44, RepositoryID: 50},
			Path: "p3.go",
			Range: clienttypes.Range{
				Start: clienttypes.Position{Line: 31, Character: 32},
				End:   clienttypes.Position{Line: 33, Character: 34},
			},
		},
	}, nil)
	...
	expectedDefinitions := []AdjustedLocation{
		{
			...
			Path:           "p1.go",
			AdjustedCommit: "deadbeef2",
			AdjustedRange: clienttypes.Range{
				Start: clienttypes.Position{Line: 110, Character: 120},
				End:   clienttypes.Position{Line: 130, Character: 140},
			},
		},
		{
			Dump:           store.Dump{ID: 44, RepositoryID: 50},
			...
			AdjustedCommit: "deadbeef2",
			AdjustedRange: clienttypes.Range{
				Start: clienttypes.Position{Line: 210, Character: 220},
				End:   clienttypes.Position{Line: 230, Character: 240},
			},
		},
		{
			Dump:           store.Dump{ID: 44, RepositoryID: 50},
			...
			AdjustedCommit: "deadbeef2",
			AdjustedRange: clienttypes.Range{
				Start: clienttypes.Position{Line: 310, Character: 320},
				End:   clienttypes.Position{Line: 330, Character: 340},
			},
		},
	}
...
func TestReferences(t *testing.T) {
	...
	mockBundleClient.MonikersByPositionFunc.SetDefaultReturn([][]clienttypes.MonikerData{{testMoniker1, testMoniker2}}, nil)
...
func TestHover(t *testing.T) {
	...
	mockCodeIntelAPI.HoverFunc.SetDefaultReturn("hover text", clienttypes.Range{
		Start: clienttypes.Position{Line: 11, Character: 12},
		End:   clienttypes.Position{Line: 13, Character: 14},
	}, true, nil)

	// first requested dump (dump 43) has no defined hover
	mockCodeIntelAPI.HoverFunc.PushReturn("", clienttypes.Range{}, false, nil)
