...
func TestAdjustPosition(t *testing.T) {
	...
	posIn := clienttypes.Position{Line: 302, Character: 15}
	...
	expectedPos := clienttypes.Position{Line: 294, Character: 15}
...
func TestAdjustPositionEmptyDiff(t *testing.T) {
	...
	posIn := clienttypes.Position{Line: 10, Character: 15}
...
func TestAdjustRange(t *testing.T) {
	...
	rIn := clienttypes.Range{
		Start: clienttypes.Position{Line: 302, Character: 15},
		End:   clienttypes.Position{Line: 305, Character: 20},
	}
	...
	expectedRange := clienttypes.Range{
		Start: clienttypes.Position{Line: 294, Character: 15},
		End:   clienttypes.Position{Line: 297, Character: 20},
	}
